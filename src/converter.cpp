...
void Converter::convert() {
    ...
    if (inputIsBinary) {
        ...
        if (outputIsBinary) {
            ...
            cerr << "Error: Conversion from binary to text format is not supported." << endl;
            throw runtime_error("Conversion from binary to text format is not supported.");
        }
    } else {
        // Parse text data
        ...
        if (outputIsBinary) {
            ...
            cerr << "Error: Conversion from text to binary format is not supported." << endl;
            throw runtime_error("Conversion from text to binary format is not supported.");
        } else {
